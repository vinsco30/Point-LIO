...
extern bool point_selected_surf[100000]; // = {0}; extern to allow multiple source files to access the same global variable
...
extern bool first;
extern int added;
extern Eigen::Matrix<double, Eigen::Dynamic, 12> h_tot;
...
/*State vector without IMU as input*/
...
/*State vector with IMU as input*/
...
((vect3, nba))
 ...
 /*Definition of kf_input/output from class esekf with state_input/output*/
...
/*Covariance matrices computation function with and without IMU*/
...
/*Observation models computation*/
